...
import { PolygonBackground } from '@/tools/portfolio/components/polygon-3d/PolygonBackground';
import { usePauseWhenHidden } from '@/tools/portfolio/hooks/usePauseWhenHidden';
