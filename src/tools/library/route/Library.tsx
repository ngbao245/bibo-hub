...
import {
  ...
  useUploadBook,
  type UploadProgress,
} from '@/tools/library/api/books';
import { useAllProgress } from '@/tools/library/api/progress';
import { useReaderStorageUsage, isStorageWarn } from '@/tools/library/api/usage';
import { CompressError } from '@/tools/library/lib/pdf-compress';
import { downloadBlob, exportAllNotes, exportBookNotes } from '@/tools/library/lib/note-pack';
import type { Book, ReadingProgress } from '@/tools/library/lib/types';
import BookCover from '@/tools/library/components/BookCover';
import StorageBadge from '@/tools/library/components/StorageBadge';
import UploadProgressPanel, { type UploadItem } from '@/tools/library/components/UploadProgressPanel';
import BookActionsMenu from '@/tools/library/components/BookActionsMenu';
import DeleteConfirmDialog from '@/tools/library/components/DeleteConfirmDialog';
import ReplaceBookDialog from '@/tools/library/components/ReplaceBookDialog';
import ImportNotesDialog from '@/tools/library/components/ImportNotesDialog';
import { useAuthStore } from '@/stores/authStore';
import { evictExpiredEntries } from '@/tools/library/lib/blob-cache';
  ...
  return (
    <div className="flex h-full flex-col bg-zinc-950 text-zinc-100">
      ...
      >
        ...
        {booksQuery.isLoading ? null : booksQuery.error ? (
      ...
      >
        {book.cover_url ? (
          <BookCover
            ...
            storageNodeId={book.storage_node_id}
          />
        ) : null}
