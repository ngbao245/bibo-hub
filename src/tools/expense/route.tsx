...
import ExpenseInput from '@/tools/expense/components/ExpenseInput';
import ExpenseList from '@/tools/expense/components/ExpenseList';
import ExpenseStats from '@/tools/expense/components/ExpenseStats';
