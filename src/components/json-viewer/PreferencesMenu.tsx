...
// State persist qua useJsonViewerPrefsStore.
// ============================================================
...
export function PreferencesMenu() {
  ...
  const setGraphTheme = useJsonViewerPrefsStore((s) => s.setGraphTheme);
  const setZoomOnScroll = useJsonViewerPrefsStore((s) => s.setZoomOnScroll);
  const setShowRuler = useJsonViewerPrefsStore((s) => s.setShowRuler);
