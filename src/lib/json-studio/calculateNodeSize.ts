// ============================================================
// Calculate node size cho graph - extract từ jsoncrack-react
// Apache 2.0 license
// ============================================================
...
/** Clear node-size measurement cache. Dùng khi data thay đổi nhiều / unmount. */
export const clearNodeSizeCache = (): void => {
  sizeCache.clear();
  lastCacheClearAt = Date.now();
};

/** Cho cache-inspector / debug: số entries hiện tại. */
export const getNodeSizeCacheSize = (): number => sizeCache.size;